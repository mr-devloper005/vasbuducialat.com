export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'vasbuducialat',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Vasbuducialat',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'vasbuducialat.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://vasbuducialat.com',
