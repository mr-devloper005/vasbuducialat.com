...
function uniquePosts(posts: SitePost[]) {
  return Array.from(
    new Map(posts.map((post) => [post.slug || post.id || post.title, post])).values(),
  )
}
  ...
  return (
    <EditableSiteShell>
      <main>
        ...
        <div className="mx-auto w-full max-w-[var(--editable-container)] px-[var(--editable-pad-x)] py-10">
